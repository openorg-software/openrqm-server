...
public interface ElementsApi {
    ...
    @ApiOperation(value = "", nickname = "elementsGet", notes = "", response = RQMElements.class, tags={ "elements", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Elements successfully fetched", response = RQMElements.class) })
    @RequestMapping(value = "/elements",
        method = RequestMethod.GET)
    ResponseEntity<RQMElements> elementsGet(@ApiParam(value = "The document id for which the elements are fetched") @Valid @RequestParam(value = "documentid", required = false) Long documentid);
