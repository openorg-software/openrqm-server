...
public class RQMDocument {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, rqMDocument.id) && Objects.equals(this.workspaceId, rqMDocument.workspaceId)
        ...
        && Objects.equals(this.name, rqMDocument.name) && Objects.equals(this.shortName, rqMDocument.shortName)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, workspaceId, internalIdentifier, externalIdentifier, name, shortName, description,
        confidentiality, authorId, languageId, approverId, reviewerText, lastModifiedById, lastModifiedOn,
        baselineMajor, baselineMinor, baselineReview, previousBaselineId);
  }
