...
public class PdfExporter {
    ...
    public void transformElement(RQMElement element) {
        ...
        LatexTransformationNodeVisitor latexTransformation = new LatexTransformationNodeVisitor();
        NodeTraversor.traverse(latexTransformation, document.body());
        element.setContent(latexTransformation.content);
    }
}
